...
define('TYPING_DELAY_MIN', 1);           // Minimum delay in seconds
define('TYPING_DELAY_MAX', 3);           // Maximum delay in seconds
...
if (isset($_GET['test_save'])) {
    ...
    function manual_save_to_csv($movie_name, $message_id, $channel_info) {
        $entry = [$movie_name, $message_id, $channel_info];
        $handle = fopen(CSV_FILE, "a");
        if ($handle !== FALSE) {
            fputcsv($handle, $entry);
            fclose($handle);
    ...
    manual_save_to_csv("Metro In Dino 2025 WebRip", 1925, "@ETBackup");
    manual_save_to_csv("Metro In Dino (2025) Theater Print", 1926, "@threater_print_movies");
    manual_save_to_csv("Animal (2023) Hindi", 1927, "@BackupChannel2");
    manual_save_to_csv("Avengers Endgame (2019) English", 1928, "@PrivateChannel");
    manual_save_to_csv("KGF Chapter 2 (2022)", 1929, "@AnyForwardedChannel");
    manual_save_to_csv("Pushpa 2 The Rule (2024)", 1930, "@EntertainmentTadka7860");
...
if (!isset($update) || !$update) {
    ...
    echo "<p><strong>Telegram Bot:</strong> Multi-channel movie forwarding system</p>";
    
    echo "<h3>📢 Configured Channels:</h3>";
    echo "<ul>";
    echo "<li><strong>Main:</strong> " . CHANNEL_1_USERNAME . " (" . CHANNEL_1_ID . ")</li>";
    echo "<li><strong>Backup:</strong> " . CHANNEL_2_USERNAME . " (" . CHANNEL_2_ID . ")</li>";
    echo "<li><strong>Theater:</strong> " . CHANNEL_3_USERNAME . " (" . CHANNEL_3_ID . ")</li>";
    echo "<li><strong>Backup2:</strong> " . CHANNEL_4_USERNAME . " (" . CHANNEL_4_ID . ")</li>";
    echo "<li><strong>Private:</strong> " . CHANNEL_5_USERNAME . " (" . CHANNEL_5_ID . ")</li>";
    echo "<li><strong>Any:</strong> " . CHANNEL_6_USERNAME . " (" . CHANNEL_6_ID . ")</li>";
    echo "<li><strong>Group:</strong> " . GROUP_USERNAME . " (" . GROUP_ID . ")</li>";
    echo "</ul>";
    ...
    echo "<p><strong>CSV Format:</strong> movie_name,message_id,channel_info</p>";
    echo "<p><strong>Delay Typing:</strong> " . (TYPING_DELAY_ENABLED ? 'Enabled' : 'Disabled') . "</p>";
    ...
    echo "<ul>";
    echo "<li>✅ 6-channel forwarding with forward headers</li>";
    echo "<li>✅ New CSV format: movie_name,message_id,channel_info</li>";
    echo "<li>✅ /addmovie command for admin</li>";
    echo "<li>✅ Delay typing feature</li>";
    echo "<li>✅ Auto-backup system</li>";
    echo "<li>✅ User points & leaderboard</li>";
    echo "<li>✅ Paginated browsing</li>";
    echo "<li>✅ Smart search algorithm</li>";
    echo "<li>✅ Auto-notification for requested movies</li>";
    echo "<li>✅ Group message filtering</li>";
    echo "<li>✅ Maintenance mode</li>";
    echo "</ul>";
    
    echo "<h3>🎯 Main Commands</h3>";
    echo "<ul>";
    ...
    echo "<li><code>/channel theater</code> - Theater prints only</li>";
    echo "<li><code>/addmovie</code> - Add movie (admin)</li>";
    ...
    echo "<li><code>/channels</code> - Join channels</li>";
    echo "</ul>";
